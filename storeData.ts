...
class TaskDetails implements taskData {
  ...
  storeData(): void {
    ...
    //console.log("pushing data to store in Local Storage");

    //console.log((<HTMLInputElement>document.getElementById("taskid")).value);
    ...
    //console.log(formdata);
    //console.log("storeData() after saving data in LS");
  ...
  deleteTable(): void {
    ...
    console.log("table removed on refresh");
  }
...
searchTableColumns(){
  ...
  const searchinput = document.getElementById("searchbtn") as HTMLButtonElement;
